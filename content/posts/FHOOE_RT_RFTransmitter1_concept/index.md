---
title: "Car → Pitwall Telemetry Transmission Solution"
...
Speedwise it is sufficient(ly overkill) and supports proper CAN-FD interfacing with any standard CAN transceiver.
...
This allows it to decode signals even with negative Signal-to-Noise ratios down to $\pu{-20dB}$.
...
The peak ranges of LoRa with around $\pu{10km}$ **L**ine **O**f **S**ight are simply not neccessary in a Formula Student context.
